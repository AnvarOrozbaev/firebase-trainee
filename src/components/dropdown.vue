...
export default {
  ...
  //1//0c92Awm5SwjdjCgYIARAAGAwSNwF-L9Ir-j5G0Gjx3WqpVPg044UGmVEbBGHXkGSszunr7vn1a75gC1nYAjXifdZoawVj0-gfcFk
  methods: {
    resetSelection () {
      this.selectedItem = {}
    ...
    selectItem (theItem) {
      ...
      db.ref("users").child(firebase.auth().currentUser.uid).child("country").set(theItem.name);
